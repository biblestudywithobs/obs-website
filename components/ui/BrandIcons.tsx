// Real brand marks + official colors (sourced from Simple Icons, the
// standard reference for accurate brand SVGs) — used anywhere OBS links out
// to its Substack, Medium, YouTube, or Spotify presence.
...
export function SubstackIcon({ className }: { className?: string }) {
  return (
    <svg role="img" viewBox="0 0 24 24" className={className} fill={brandColors.substack}>
...
export function MediumIcon({ className }: { className?: string }) {
  return (
    <svg role="img" viewBox="0 0 24 24" className={className} fill={brandColors.medium}>
...
export function YouTubeIcon({ className }: { className?: string }) {
  return (
    <svg role="img" viewBox="0 0 24 24" className={className} fill={brandColors.youtube}>
...
export function SpotifyIcon({ className }: { className?: string }) {
  return (
    <svg role="img" viewBox="0 0 24 24" className={className} fill={brandColors.spotify}>
